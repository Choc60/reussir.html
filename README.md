...
<head>
    ...
    <title>Agenda des Commerciaux - Édition Premium</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { 
            ...
            background: linear-gradient(135deg, var(--primary-color) 0%, #004d00 100%); 
...
<body>
    ...
    <div id="form-ajout">
        <h3><i class="fas fa-user-plus"></i> Ajouter un commercial</h3>
